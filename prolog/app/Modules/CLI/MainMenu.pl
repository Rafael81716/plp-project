:- module(_,[printMainMenu/0, readMainMenu/1,printUserMenu/1,readUserMenu/2]).
...
checkOption(_,Option):- Option >= 1, Option =< 11,!.
...
readUserMenu(11, _):- write("tchau tchau \n"),halt.


verificaIntegridadeUserOption(Numero, Number, _) :- 
valid_codes(Numero),
number_codes(Number, Numero). 
